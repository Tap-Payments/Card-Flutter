...
![](https://img.shields.io/badge/pub-1.0.1-green)
...
TapCardViewWidget(
  ...
  // This is a stateful variable, if set to true token will be generated. Check the next section
...
| purpose| Defines the intention of using the `Token` after generation. | True  | String| String purpose = "Transaction"` |
...
| features| Some extra features that you can enable/disable based on the experience you want to provide.. | False  | `Map`| ` features = {"alternativeCardInputs":{"cardScanner":true}, "acceptanceBadge":true, "customerCards":{"saveCard":false, "autoSaveCard":false}}`|
...
| fieldVisibility| Needed to define visibility of the optional fields in the card form. | False  | `Map`| ` fieldVisibility = {"card":{"cardHolder":true}}` |
| interface| Needed to defines look and feel related configurations. | False  | `Map`| ` interface = {"locale": "en", "theme": "light", "edges": "curved", "direction": "dynamic", "powered": true, "colorStyle": "colored", "loader": true}` |
...
## Advanced Initialisation of the widget
